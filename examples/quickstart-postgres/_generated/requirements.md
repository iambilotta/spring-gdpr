# Requirements — spring-gdpr-example-quickstart-postgres
...
#### `FR-(root).QuickstartE2E#accessExportReturnsTheSubjectsClassifiedFieldsForDpo`

- _(spec missing — add `@spec.given` / `@spec.when` / `@spec.then` javadoc)_
- **File**: `examples/quickstart-postgres/src/test/java/com/example/gdprdemo/QuickstartE2ETest.java`

#### `FR-(root).QuickstartE2E#createCustomerAndFetchHits200`

- _(spec missing — add `@spec.given` / `@spec.when` / `@spec.then` javadoc)_
- **File**: `examples/quickstart-postgres/src/test/java/com/example/gdprdemo/QuickstartE2ETest.java`

#### `FR-(root).QuickstartE2E#erasureEndpointAccessibleToDpoRole`

- _(spec missing — add `@spec.given` / `@spec.when` / `@spec.then` javadoc)_
- **File**: `examples/quickstart-postgres/src/test/java/com/example/gdprdemo/QuickstartE2ETest.java`

#### `FR-(root).QuickstartE2E#erasureEndpointForbiddenForNonDpoRole`

- _(spec missing — add `@spec.given` / `@spec.when` / `@spec.then` javadoc)_
- **File**: `examples/quickstart-postgres/src/test/java/com/example/gdprdemo/QuickstartE2ETest.java`

#### `FR-(root).QuickstartE2E#unauthenticatedAccessIsRejected`
