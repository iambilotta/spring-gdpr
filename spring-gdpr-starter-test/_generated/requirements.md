# Requirements — spring-gdpr-starter-test
...
#### `FR-(root).GdprIntegration#advisorEmitsAuditRecordOnPersonalDataAccess`

- _(spec missing — add `@spec.given` / `@spec.when` / `@spec.then` javadoc)_
- **File**: `spring-gdpr-starter-test/src/test/java/com/iambilotta/gdpr/demo/GdprIntegrationTest.java`

#### `FR-(root).GdprIntegration#erasureRemovesCustomerAcrossAllHandlers`
