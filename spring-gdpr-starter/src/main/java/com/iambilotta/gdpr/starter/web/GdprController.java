 ...
 * <p>Endpoints exposed:
 * <ul>
 *   <li>{@code DELETE /gdpr/erasure/{subjectId}} runs all configured {@code @GdprErasable} handlers</li>
...
public class GdprController {
    ...
    public GdprController(ErasureService erasureService, AuditSink auditSink) {
